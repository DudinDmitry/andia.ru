    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="/admin" class="brand-link">
            <img src="/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
            <span class="brand-text font-weight-light">Andia</span>
        </a>
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    ...
                    <form method="post"> @csrf
                        <input type="submit" name="logout" value="Выйти" class="btn btn-xs btn-outline-success">
                    </form>
                </div>
            </div>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item has-treeview">
                        <a href="/admin/users"
                           class="nav-link @if($_SERVER['REQUEST_URI']=='/admin/users') active @endif">
                    ...
                    <li class="nav-item has-treeview">
                        <a href="#" class="nav-link ">
                            ...
                            <p class="
@if($_SERVER['REQUEST_URI']=='/admin/blog/categories'
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="/admin/blog/categories"
                                   class="nav-link @if($_SERVER['REQUEST_URI']=='/admin/blog/categories') active @endif">
...
OR $_SERVER['REQUEST_URI']=='/admin/shop/add-product') text-blue @endif">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">{{$meta['h1'] ?? 'Админ-панель'}}</h1>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">@yield('content')
                    </div>
                    <!-- /.col-md-6 -->
                </div>
                <!-- /.row -->
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Панель администратора <a href="">Andia.ru</a>.</strong>
    </footer>
</div>
<!-- ./wrapper -->
