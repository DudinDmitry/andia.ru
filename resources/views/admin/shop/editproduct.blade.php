                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <div class="input-group input-group-lg">
                                        ...
                                        <input type="text" class="form-control" aria-label="Large" name="edit[title]"
                                               aria-describedby="inputGroup-sizing-sm" value="{{$product->title ?? ''}}"
                                               placeholder="Введите название товара" required>
                                    </div>
                                    <textarea class="form-control" id="textarea" name="edit[body]"
                                              rows="32"
                                              placeholder="Опишите этот товар, его преимущества, почему его должны купить именно у Вас?"
                                ...
                                <div class="col-md-2 border alert alert-default-info ">
                                    ...
                                    <div class="form-group">
                                        <label>Цена</label>
                                        <input type="number" name="edit[price]" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="edit[category_id]" class="form-control" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="edit[active]" class="form-control">
                                            <option value="1" @if($product->product_active==1) selected @endif>
                                                Опубликована
                                            </option>
                                            <option value="0" @if($product->product_active==0) selected @endif>
                                                Скрыть
                                            </option>
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6 ">
                                        ...
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                <input type="checkbox" aria-label="Checkbox for following text input"
                                                       name="check[title]" @if(isset($product->meta_title)) checked @endif>
                                                &nbsp; Title
                                            </div>
                                        </div>
                                        <input type="text" class="form-control" aria-label="Text input with checkbox"
                                               name="meta[title]"
                                               @if(isset($product->meta_title)) value="{{$product->meta_title}}" @endif
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">
                                                <input type="checkbox" aria-label="Checkbox for following text input"
                                                       name="check[description]" @if(isset($product->meta_description)) checked @endif>
                                                &nbsp; Description
                                            </div>
                                        </div>
                                        <textarea class="form-control" aria-label="Text input with checkbox"
                                                  ...
                                                  rows="3">@if(isset($product->meta_description)){{$product->meta_description}}@endif</textarea>
                                    </div>
                                </div>
                                <div class="col-md-6 ">
